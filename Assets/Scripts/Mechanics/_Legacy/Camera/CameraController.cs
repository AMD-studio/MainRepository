...
public class CameraController : MonoBehaviour
{
    ...
    void RotateCamera()
    {
        float mouseY = Mouse.current.delta.y.ReadValue() * cameraSettings.MouseY_Sensitivity;
        float mouseX = Mouse.current.delta.x.ReadValue() * cameraSettings.MouseX_Sensitivity;
